...
import com.o9studio.unnamedmod.core.ModMenus;
...
public class CrystalTableMenu extends AbstractContainerMenu {
    private final CrystalTableEntity blockEntity;
    ...
    public CrystalTableMenu(int id, Inventory inv, BlockEntity entity, ContainerData data){
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(handler -> {
            this.addSlot(new SlotItemHandler(handler, 0, 26, 45));
    ...
    public int getScaledProgress() {
        ...
        int progressArrowSize = 71; // This is the height in pixels of your arrow
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), player, ModBlocks.CRYSTAL_TABLE.get());
    }
